...
public class OrderSetupConfiguration {
	...
	public OrderSetupConfiguration(String[][] orderSetupData){
	...
	public String toString() {
		return "OrderSetupConfiguration [addressType=" + addressType + ", deliverTo=" + deliverTo + ", address1=" + address1 + ", address2=" + address2 + ", city=" + city + ", province=" + province + ", postalCode=" + postalCode + ", crossStreet=" + crossStreet + ", specialInstructions=" + specialInstructions + ", searchQuery=" + searchQuery + ", futureDate=" + futureDate + ", futureTime=" + futureTime + "]";
	}
}
